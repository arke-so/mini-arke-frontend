...
export interface ComputeOrderCompletionDetails {
     ...
     */
    products: Array<ComputeOrderCompletionItem>;
}
...
export function ComputeOrderCompletionDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComputeOrderCompletionDetails {
    ...
    return {
        ...
        'products': ((json['products'] as Array<any>).map(ComputeOrderCompletionItemFromJSON)),
    };
}
...
export function ComputeOrderCompletionDetailsToJSONTyped(value?: ComputeOrderCompletionDetails | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'products': ((value['products'] as Array<any>).map(ComputeOrderCompletionItemToJSON)),
    };
}
