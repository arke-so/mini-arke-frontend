...
<svg stroke-width="1.5" viewBox="0 0 24 24" fill="none" color="currentColor" {...$$restProps}>
  ...
  <path
    ...
    stroke-linecap="round"
    stroke-linejoin="round"></path>
  <path d="M6 16V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
  <path d="M12 6V3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
  <path d="M18 16V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>
